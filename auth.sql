...
--
-- Host: 127.0.0.1
-- Czas generowania: 13 Maj 2024, 13:58
...
--
-- Struktura tabeli dla tabeli `lekarzeone`
--

CREATE TABLE `lekarzeone` (
  `ID` int(11) NOT NULL,
  `imie` text NOT NULL,
  `nazwisko` text NOT NULL,
...
(56, 'fdgdffd', 'sdfsd', 'ad@saef.pl', '$argon2i$v=19$m=65536,t=4,p=1$NFQ5R1FHbnlhcTE2ZGZySw$Eebjayo8/mT1VSG6hVh8bmkKCLD4qK8PDcO+0+49uaE'),
(57, 'fdgdffd', 'sdfsd', 'ad@saef.pl', '$argon2i$v=19$m=65536,t=4,p=1$ZjhhVlUxZjhMbkoyZDJWLg$W3+YckArAXBaaMg0ZonGHMOh5VVo48nbRgrp4PdI2d0'),
(58, 'fdgdffd', 'sdfsd', 'ad@saef.pl', '$argon2i$v=19$m=65536,t=4,p=1$Y292eEplNk9LM2suQ0JsZA$P2OF9VCyqOv328gYGVuIOLbBDR72EmvAdb2NdvN9XZQ'),
(59, 'haysdvas', 'fadadsdf', 'adsfas@sefs.pl', '$argon2i$v=19$m=65536,t=4,p=1$SEgwSG9ZTzMyelc2ZVBTUg$duiJqgev2Fqdb5abU0I2s9fxDN+PbGxaIJpulh/Tx9g'),
(60, 'haysdvas', 'fadadsdf', 'adsfas@sefs.pl', '$argon2i$v=19$m=65536,t=4,p=1$SERYczIzak1LZ0txWWl6Tw$PBbmupWKPBwZ68keUe6o7gVzkVbEh3Hdq+pYd6IueCU'),
(61, 'haysdvas', 'fadadsdf', 'adsfas@sefs.pl', '$argon2i$v=19$m=65536,t=4,p=1$UVBMQmZ4bVkwbzYvVUxuMQ$viIxAemSNe3S4KTf+fYVE61zw7NOUN76lVi6Jl3yET8'),
(62, 'haysdvas', 'fadadsdf', 'adsfas@sefs.pl', '$argon2i$v=19$m=65536,t=4,p=1$VWh5Z2Mxcm9ueVBtekdwWA$KJwUb86Rck2EEEVL8IYwu2Gj+XCgCeg7HRLdoKUEmnY'),
(63, 'sef', 'esf', 'se@sdef.sda', '$argon2i$v=19$m=65536,t=4,p=1$NWhNUmpwZUQ0dVc0YmhCVQ$94BXoNjxs4LoyeKK60mQsShQ5rM25GxFlKYbnyPG8Ro');
...
--
-- Indeksy dla tabeli `lekarzeone`
--
ALTER TABLE `lekarzeone`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT dla tabeli `lekarzeone`
--
ALTER TABLE `lekarzeone`
